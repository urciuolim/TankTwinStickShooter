...
**Inspiration (do NOT copy):** `src/tank_twin/features.py`, the flat/spatial/heatmap paradigms in `_pretrain_pixels_train.py`; Unity ml-agents `encoders.py` (IMPALA-ResNet + the proven ONNX→Sentis export path).
