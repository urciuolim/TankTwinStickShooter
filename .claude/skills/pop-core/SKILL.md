...
**Inspiration (do NOT copy):** the 2021 protocol/state originals (retired to git history). Build fresh — match the Unity wire contract exactly (52-float layout, JSON shape, big-endian frame header), but this is NEW code.
