...
**Inspiration (do NOT copy):** `src/tank_twin/pretrain_pixels.py` + `_pretrain_pixels_train.py`. NOTE: that is the legacy 53%-of-src, cycle-bearing, 2,112-line mass — build this CLEAN and SPLIT: small cohesive modules, **no import cycle**, no 2,000-line files.
