...
- Build it FRESH from the design/algorithm. Use `PythonScripts/` (2021) and `src/tank_twin/` as **inspiration** to understand intent — never copy them wholesale or carry their cruft. We are not reproducing old code.
...
- Do NOT touch `src/tank_twin/` or the frozen RL seam, and do NOT modify other components' files.
